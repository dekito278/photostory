        ...
        <div class="container"><a href="#" class="navbar-brand text-uppercase font-weight-bold">STORY PHOTO</a>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
				...
				if (file_exists('index.php')){
    				...
    				?>
					<li class="nav-item"><a href="log_pam.php" class="nav-link text-uppercase font-weight-bold">Login</a></li>
					<li class="nav-item"><a href="reg_pam.php" class="nav-link text-uppercase font-weight-bold">Register</a></li>
					<?php
					}
					?>
                </ul>
